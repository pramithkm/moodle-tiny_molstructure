...
export const initCanvas3D = async(editor, iframeBody, sketcherWidth=400, sketcherHeight=200, sketcherViewerWidth=100, sketcherViewerHeight=100) => {
...
export const function_resize= (e) => {
  ...
  let sketcher_viewer = window.document.querySelector(Selectors.elements.canvas.selector3D).contentWindow.sketcherViewerVar;
  let width;
  let height;
